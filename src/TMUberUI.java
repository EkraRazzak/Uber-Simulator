    ...
    try (Scanner scanner = new Scanner(System.in)) {
      ...
      while (scanner.hasNextLine())
      {
        ...
        else if (action.equalsIgnoreCase("REQRIDE")) 
        {
          ...
          // Start code
          System.out.print("User Account Id: "); // receive user input of account id, from address, to address from 
          ...
          if (!tmuber.requestRide(userAccountId, fromAddress, toAddress)) // if ride request is invalid, get error message
            System.out.println(tmuber.getErrorMessage());
          else
          {
            User user = tmuber.getUser(userAccountId);
            System.out.println("RIDE for: " + user.getName() + " From: " + fromAddress + " To: " + toAddress); // print details
          }
          // End code
        }
        ...
        else if (action.equalsIgnoreCase("REQDLVY")) 
        {
          ...
          // Start code
          System.out.print("User Account Id: "); // receive user input of account id, from address, to address, restaurant, food order no.
          String userAccountId = scanner.nextLine();
          ...
          if (!tmuber.requestDelivery(userAccountId, fromAddress, toAddress, restaurant, foodOrderId)) // if delivery request is invalid, get error message
          {
            System.out.println(tmuber.getErrorMessage());
          }
          else 
          {
            User user = tmuber.getUser(userAccountId);
            System.out.println("DELIVERY for: " + user.getName() + " From: " + fromAddress + " To: " + toAddress); // print details
          }
          // End code
        }
        // Sort users by name
